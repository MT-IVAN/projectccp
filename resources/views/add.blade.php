		    ...
		    <div class="form-group">
		    	<label class="sr-only" for="inlineFormInputGroup">Digita la clave</label>
  				<div class="input-group mb-2 mr-sm-2 mb-sm-0">
    				...
    				<input name="clave" type="text" required pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" class="form-text form-control"placeholder="Digita la clave">
  				</div>
		        ...
		        <label class="sr-only" for="inlineFormInputGroup">Digita el distractor 1</label>
  				<div class="input-group mb-2 mr-sm-2 mb-sm-0">
    				...
    				<input name="distractor1" type="text" required pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" class="form-text form-control"placeholder="Digita el primer distractor">
  				</div>
  				...
  				<div class="input-group mb-2 mr-sm-2 mb-sm-0">
    				...
    				<input name="distractor2" type="text" required pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" class="form-text form-control"placeholder="Digita el segundo distractor">
  				</div>
  				<small class="form-text text-muted">Será una opción incorrecta de la pregunta</small>
  				...
  				<div class="input-group mb-2 mr-sm-2 mb-sm-0">
    				...
    				<input name="nivel" type="number" class="form-text form-control" min="1" max="9" placeholder="Digita el nivel de dificultad" required>
  				</div>
